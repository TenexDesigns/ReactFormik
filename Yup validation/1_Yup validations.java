Yup is a versatile schema validation library that can be used to validate a wide range of data types and structures. Here's a list of common items you can validate using Yup and how to use them:
